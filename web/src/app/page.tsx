...
const modeCards = [
  {
    href: "/video",
    title: "영상 리뷰",
    summary: "영상을 업로드하고 후보 얼굴을 검토한 뒤 유지, 가림, 디퓨전 대체 결과를 다운로드합니다.",
    status: "연결됨",
    highlights: ["후보 분석", "디퓨전 대체", "QA 리포트"],
  },
] as const;
...
export default function HomePage() {
  ...
  return (
    <AppShell
      ...
      title="개요"
      description="업로드 영상의 후보 얼굴을 검토하고, 유지/가림/디퓨전 대체 결정을 결과 영상과 QA 리포트에 반영하는 콘솔입니다."
        ...
        <div className="auto-grid">
          <PanelCard kicker="운영 메모" title="먼저 확인할 것" description="각 흐름에 들어가기 전 확인할 핵심 항목을 정리했습니다.">
            <ul className="notes-list">
              <li>영상 리뷰가 단일 핵심 제품 흐름이며 브라우저 입력 프리뷰는 포함하지 않습니다.</li>
              <li>유지/가림/디퓨전 대체 결정은 후보 리뷰 보드에서 인물별로 지정합니다.</li>
              <li>후보 분석은 영상 처리 전에 검토 가능한 얼굴 crop을 준비합니다.</li>
            </ul>
          </PanelCard>
          <PanelCard kicker="첫 실행 추천" title="빠른 스모크 테스트" description="전체 제품 루프가 정상인지 확인하는 간단한 운영 흐름입니다.">
            <ol className="ordered-list">
              ...
              <li>샘플을 가림 또는 디퓨전 대체 모드로 처리하고 완료 결과 다운로드를 확인합니다.</li>
            </ol>
          </PanelCard>
        </div>
      </div>
