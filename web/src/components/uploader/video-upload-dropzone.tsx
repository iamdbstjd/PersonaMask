    ...
    <div className="stack-sm">
      ...
      >
        ...
        <div className="dropzone__body">
          <p className="dropzone__title">소스 영상을 드롭하거나 로컬 파일을 선택하세요</p>
          <p className="dropzone__helper">{helperText}</p>
          <StatusBadge label={dragActive ? "지금 놓기" : "준비됨"} tone={dragActive ? "warning" : "success"} />
        </div>

        <div className={["dropzone__file", file ? "dropzone__file--selected" : "dropzone__file--empty"].join(" ")}>
          {file ? (
            <>
